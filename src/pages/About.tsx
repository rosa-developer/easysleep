    ...
    <div className="container-custom py-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-16 items-center">
        <div>
          ...
          <h3 className="text-2xl font-semibold mb-4 text-gray-800">Our Approach</h3>
          <p className="text-gray-600 mb-6">
          ...
          <ul className="space-y-4">
            {[
              ...
              <li key={index} className="flex">
                <div className="flex-shrink-0 w-10 h-10 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center mr-4">
                  {index + 1}
                </div>
                <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
          {[
            ...
            <div key={index} className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
              <div className="w-24 h-24 bg-blue-100 rounded-full mb-4 mx-auto"></div>
              <h4 className="text-xl font-semibold text-center text-gray-800">{member.name}</h4>
              <p className="text-blue-500 text-center mb-2">{member.role}</p>
      ...
      <div className="text-center mt-20">
        <h3 className="text-2xl font-semibold mb-4 text-gray-800">Ready to Transform Your Sleep?</h3>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button className="bg-blue-500 hover:bg-blue-600 text-white px-6 py-6 rounded-md transition-all duration-300">
            Get Started Today
          </Button>
          <Link to="/contact">
